...
void lista::suma2Num(int v1, int v2){
	...
	else
	{
		L1->crearListaNum(v1);
		L2->crearListaNum(v2);
	/*	while(v1!=0) Otra forma de hacerlo
		{
			int temp =v1%10;
			int temp2 =v2%10;
...
//los digitos pares se elevan a la 3 y los impares a la dos.
...
void lista::enlazarListas(int a,int b) {
	...
	if(L1->largoLista() == 6 && L2->largoLista() == 6){
	while(aux->siguiente->siguiente!=NULL){
	...
	L2->Mostrar();
		...
		cout<<"\nListas no son iguales, ambos numeros deben tener 6 digitos "<<endl;
	}
...
/*
   cout<<"\nPregunta 7: Escribir una función que recibe dos números de igual tamaño"<<endl;
   cout<<" se insertan en dos listas y se suman. Los nodos, dejando una lista nueva"<<endl;
   L1.suma2Num(12345, 76587);
  
 */  
   
/*   
   cout<<"Pregunta 8: Recibe un numero, lo separa en una lista y"<<endl;
   cout<<"los digitos pares se elevan a la 3 y los impares a la dos."<<endl;
   L8.elevarParesImpares(23232323);
   L8.Mostrar();
*/
