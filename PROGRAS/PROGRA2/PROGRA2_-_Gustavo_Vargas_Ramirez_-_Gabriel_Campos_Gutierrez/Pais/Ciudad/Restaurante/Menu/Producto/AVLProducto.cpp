...
void AVLProducto::InordenR(NodoBinarioProducto* R, NodoBinarioProducto*& masBuscado, int& maxContador) {
    ...
    AVLProducto::InordenR(R->Hizq, masBuscado, maxContador);
    ...
    AVLProducto::InordenR(R->Hder, masBuscado, maxContador);
}
...
//        cout << "La Producto: " << num << " no se encuentra" << endl;
    ...
    if (num < nodoB->valor) {
        return AVLProducto::PrecioProducto(nodoB->Hizq, num);
    } else if (num > nodoB->valor) {
        return AVLProducto::PrecioProducto(nodoB->Hder, num);
    } else {
        // Producto se encuentra en el nodo actual
