...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(177, 107);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(60, 108);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(144, 55);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(143, 22);
			...
			this->ClientSize = System::Drawing::Size(343, 153);
