...
namespace Interfaz {
	...
	public:
		...
		ventanaPopupMenu(cargarArchivo* progra, bool^ flag)
		{
			this->flag = flag;
			this->progra = progra;
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label4->Location = System::Drawing::Point(178, 238);
			...
			this->button4->Location = System::Drawing::Point(157, 150);
			...
			this->label3->Location = System::Drawing::Point(36, 238);
			...
			this->button3->Location = System::Drawing::Point(26, 150);
			...
			this->label2->Location = System::Drawing::Point(178, 110);
			...
			this->button2->Location = System::Drawing::Point(157, 22);
			...
			this->label1->Location = System::Drawing::Point(38, 110);
			...
			this->button1->Location = System::Drawing::Point(26, 22);
			...
			// button5
			// 
			this->button5->Location = System::Drawing::Point(95, 271);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(75, 23);
			this->button5->TabIndex = 32;
			this->button5->Text = L"Cancelar";
			this->button5->UseVisualStyleBackColor = true;
			this->button5->Click += gcnew System::EventHandler(this, &ventanaPopupMenu::button5_Click);
			// 
			// ventanaPopupMenu
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(278, 307);
