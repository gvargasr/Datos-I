...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(143, 84);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(181, 128);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(64, 129);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(144, 45);
			...
			this->ClientSize = System::Drawing::Size(325, 160);
