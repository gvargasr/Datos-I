...
namespace Interfaz {
	...
	/// <summary>
	/// Summary for ventanaModificarRestaurante
	/// </summary>
	public ref class ventanaModificarRestaurante : public System::Windows::Forms::Form
	{
	public:
		cargarArchivo* progra;
		ventanaModificarRestaurante(cargarArchivo* progra)
		{
			this->progra = progra;
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(182, 112);
			...
			this->label4->Location = System::Drawing::Point(28, 86);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(182, 79);
			...
			this->button2->Click += gcnew System::EventHandler(this, &ventanaModificarRestaurante::button2_Click);
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(75, 151);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(75, 23);
			this->button1->TabIndex = 28;
			this->button1->Text = L"Aceptar";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &ventanaModificarRestaurante::button1_Click);
			// 
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(182, 43);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(182, 11);
			...
			this->ClientSize = System::Drawing::Size(359, 180);
			...
			this->Name = L"ventanaModificarRestaurante";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterParent;
			this->Text = L"Modificar Restaurante";
