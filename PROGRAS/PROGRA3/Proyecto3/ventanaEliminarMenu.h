...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(180, 116);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(204, 165);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(84, 165);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(180, 48);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(180, 16);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(180, 84);
			...
			this->label5->Location = System::Drawing::Point(26, 123);
			...
			this->ClientSize = System::Drawing::Size(365, 203);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (!String::IsNullOrWhiteSpace(codStrPais) && !String::IsNullOrWhiteSpace(codStrCiudad) && !String::IsNullOrWhiteSpace(codStrRestaurante) && !String::IsNullOrWhiteSpace(codStrMenu)) {
			int temp;
			int temp2;
			int temp3;
			int temp4;
