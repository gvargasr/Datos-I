...
using namespace std;
    ...
    public:
        ...
        NodoBinarioProducto* InordenR(NodoBinarioProducto* R, NodoBinarioProducto*& masBuscado, int& maxContador);
        ...
        void Reducir(NodoBinarioProducto* nodoB, int num);
        NodoBinarioProducto* ProductoMasComprado(NodoBinarioProducto* nodoB);
        void InordenRCompras(NodoBinarioProducto* R, NodoBinarioProducto*& masBuscado, int& maxContador);
        bool BuscarProductoCantidadCompra(NodoBinarioProducto* nodoB, int num);
