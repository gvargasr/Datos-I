...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(173, 100);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(56, 101);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(139, 47);
			...
			this->label1->Location = System::Drawing::Point(21, 54);
			...
			this->ClientSize = System::Drawing::Size(318, 205);
